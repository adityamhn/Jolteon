...
function getCodeAnalizer(params) {
     ...
     */ hooks.declarator.tap(NAME, (declarator)=>{
            var ref, ref1;
            if (((ref = declarator.init) == null ? void 0 : ref.type) === "MemberExpression" && isProcessEnvMemberExpression(declarator.init) && ((ref1 = declarator.id) == null ? void 0 : ref1.type) === "ObjectPattern") {
...
function getCreateAssets(params) {
    ...
    return (assets)=>{
        for (const entrypoint of compilation.entrypoints.values()){
            ...
            const page = (metadata == null ? void 0 : (ref = metadata.edgeMiddleware) == null ? void 0 : ref.page) || (metadata == null ? void 0 : (ref2 = metadata.edgeSSR) == null ? void 0 : ref2.page) || (metadata == null ? void 0 : (ref3 = metadata.edgeApiFunction) == null ? void 0 : ref3.page);
            if (!page) {
                continue;
            }
            ...
            const regexp = (metadata == null ? void 0 : (ref4 = metadata.edgeMiddleware) == null ? void 0 : ref4.matcherRegexp) || namedRegex;
