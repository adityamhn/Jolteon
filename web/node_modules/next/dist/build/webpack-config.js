...
async function getBaseWebpackConfig(dir, { buildId , config , compilerType , dev =false , entrypoints , hasReactRoot , isDevFallback =false , pagesDir , reactProductionProfiling =false , rewrites , runWebpackSpan , target ="server" , appDir , middlewareRegex  }) {
    ...
    const getBabelOrSwcLoader = ()=>{
        ...
        if (useSWCLoader && (config == null ? void 0 : (ref = config.experimental) == null ? void 0 : ref.swcTraceProfiling)) {
            ...
            ref43;
            (ref43 = require("./swc")) == null ? void 0 : ref43.initCustomTraceSubscriber == null ? void 0 : ref43.initCustomTraceSubscriber(_path.default.join(distDir, `swc-trace-profile-${Date.now()}.json`));
        }
        return useSWCLoader ? {
        ...
        plugins: [
            ...
            new _webpack.webpack.DefinePlugin({
                ...
                "process.env.__NEXT_IMAGE_OPTS": JSON.stringify({
                    ...
                    experimentalLayoutRaw: (ref3 = config.experimental) == null ? void 0 : (ref4 = ref3.images) == null ? void 0 : ref4.layoutRaw,
                    experimentalFuture: (ref5 = config.experimental) == null ? void 0 : (ref6 = ref5.images) == null ? void 0 : ref6.allowFutureImage,
                    ...dev ? {
                        // pass domains in development to allow validating on the client
                        domains: config.images.domains,
                        experimentalRemotePatterns: (ref7 = config.experimental) == null ? void 0 : (ref8 = ref7.images) == null ? void 0 : ref8.remotePatterns
                    } : {}
                }),
          ...
          `
            ...
            !dev && isClient && new (require("./webpack/plugins/telemetry-plugin")).TelemetryPlugin(new Map([
                ...
                [
                    "swcRelay",
                    !!((ref10 = config.compiler) == null ? void 0 : ref10.relay)
                ],
                [
                    "swcStyledComponents",
                    !!((ref11 = config.compiler) == null ? void 0 : ref11.styledComponents)
                ],
                [
                    "swcReactRemoveProperties",
                    !!((ref12 = config.compiler) == null ? void 0 : ref12.reactRemoveProperties), 
                ],
                [
                    "swcExperimentalDecorators",
                    !!(jsConfig == null ? void 0 : (ref13 = jsConfig.compilerOptions) == null ? void 0 : ref13.experimentalDecorators), 
                ],
                [
                    "swcRemoveConsole",
                    !!((ref14 = config.compiler) == null ? void 0 : ref14.removeConsole)
                ],
                [
                    "swcImportSource",
                    !!(jsConfig == null ? void 0 : (ref15 = jsConfig.compilerOptions) == null ? void 0 : ref15.jsxImportSource)
                ],
                [
                    "swcEmotion",
                    !!((ref16 = config.compiler) == null ? void 0 : ref16.emotion)
                ],
                SWCBinaryTarget, 
            ].filter(Boolean))), 
        ].filter(Boolean)
    ...
    if ((jsConfig == null ? void 0 : (ref17 = jsConfig.compilerOptions) == null ? void 0 : ref17.paths) && resolvedBaseUrl) {
        var ref31, ref32;
        (ref31 = webpackConfig.resolve) == null ? void 0 : (ref32 = ref31.plugins) == null ? void 0 : ref32.unshift(new _jsconfigPathsPlugin.JsConfigPathsPlugin(jsConfig.compilerOptions.paths, resolvedBaseUrl));
    }
    ...
    const configVars = JSON.stringify({
        ...
        removeConsole: (ref18 = config.compiler) == null ? void 0 : ref18.removeConsole,
        reactRemoveProperties: (ref19 = config.compiler) == null ? void 0 : ref19.reactRemoveProperties,
        styledComponents: (ref20 = config.compiler) == null ? void 0 : ref20.styledComponents,
        relay: (ref21 = config.compiler) == null ? void 0 : ref21.relay,
        emotion: (ref22 = config.compiler) == null ? void 0 : ref22.emotion,
        modularizeImports: (ref23 = config.experimental) == null ? void 0 : ref23.modularizeImports,
        legacyBrowsers: (ref24 = config.experimental) == null ? void 0 : ref24.legacyBrowsers
    });
    const cache = {
        type: "filesystem",
        // Includes:
    ...
    if (config.experimental.craCompat && ((ref25 = webpackConfig.module) == null ? void 0 : ref25.rules) && webpackConfig.plugins) {
    ...
    var ref38;
    const hasUserCssConfig = (ref38 = (ref26 = webpackConfig.module) == null ? void 0 : ref26.rules.some((rule)=>canMatchCss(rule.test) || canMatchCss(rule.include))) != null ? ref38 : false;
    if (hasUserCssConfig) {
        ...
        if ((ref39 = webpackConfig.module) == null ? void 0 : ref39.rules.length) {
